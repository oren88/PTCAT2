...
<h5 style="margin-top:15px">[Table 21-1. Chemical Composition of 동방파우텍 황토(L3)]</h5>
<br>
...
<h5>[Figure 21-1. X-Ray Diffraction of 동방파우텍 황토(L3) Materials & Phase Analysis]</h5>
<h5 style="margin-top:40px; margin-bottom:10px">[Table 21-2. Phase analysis based on X-ray Diffraction]</h5>
<table style="margin:30px 30px 10px 20px; margin-top:0px">
	...
	<tr>
		...
		<tr>
		<td>Cronstedtite 2H2</td>
		<td>22.6</td>
	</tr>
		<tr class="">
		<td>Hematite (Ti-bearing)</td>
		<td>1.1%</td>
	</tr>
		<tr>
		<td>Sodium Dialuminium Phyllo-decaoxodihydroxoalumotrisilicate</td>
		<td>59.1%</td>
	</tr>
</table>
<br>
...
<h5 style="margin-top:-10px; margin-bottom:30px;">[Figure 21-2. Particle size analysis]</h5>
<h5>[Table 21-3. Summarized particle size analysis]​</h5>
