...
<img src="{{site.baseurl}}/post_images/{{page.link}}7.jpg" style="width:80%; margin-bottom:10px;" alt="{{page.link}}7">
<h5>[Figure 1-1. X-Ray Diffraction of Loess Materials & Phase Analysis]</h5>

<table style="width:841px; margin:30px 30px 10px 20px; margin-top:40px">
	<tr>
...
<h5>[Table 1-2. Phase analysis based on X-ray Diffraction]</h5>
...
<h5 style="margin-top:-25px; margin-bottom:30px;">[Figure 1-3. Particle size analysis]</h5>


<table style="width:841px; margin:10px 30px 10px 20px;">
	<tr>
